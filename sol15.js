// Open. They would like your help with an application form that will tell prospective members which category they will be placed.
...
function openOrSenior(data){
  return data.map(([age,handic]) => age >= 55 && handic > 7 ? 'Senior' : 'Open');
}
